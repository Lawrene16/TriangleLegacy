...
var map = {
	...
	"./servicesdetails/servicesdetails.module": [
...
module.exports = "<ion-app>\n  <ion-split-pane>\n    <ion-menu type=\"overlay\">\n      <ion-content>\n        <div class=\"content_bg\">\n\n          <p style=\"margin: 0px; padding-top: 25px; padding-bottom: 40px;\" align=\"center\"><img height=\"180px\" src=\"../assets/new logo no padding.png\"></p>\n\n          <div>\n            <img (click)=\"toggleMenu()\" style=\"margin-left: 25px; margin-top: 13px;\" [routerDirection]=\"'root'\" [routerLink]=\"[p.url]\" *ngFor=\"let p of appPages\" height=\"35px\" src=\"../assets/{{p.icon}}\">\n          </div>\n\n\n          <!-- <ion-list>\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages\">\n            <ion-item [routerDirection]=\"'root'\" [routerLink]=\"[p.url]\">\n              <ion-icon slot=\"start\" [name]=\"p.icon\"></ion-icon>\n              <ion-label>\n                {{p.title}}\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list> -->\n\n        <p align=\"center\" style=\"margin:0px; padding-top: 40px;\">\n          <img height=\"34px\" src=\"../assets/White Line.png\">\n        </p>\n\n        <p align=\"center\" (click)=\"callUs()\" style=\"margin:0px;\">\n          <img height=\"34px\" src=\"../assets/24 Hour Emergency Service.png\">\n        </p>\n\n        </div>\n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet main></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n"
...
var routes = [
    ...
    { path: 'servicesdetails', loadChildren: './servicesdetails/servicesdetails.module#ServicesdetailsPageModule' }
];
...
module.exports = ".content_bg {\n  background-image: url('new sidebar.png');\n  background-repeat: no-repeat;\n  background-size: cover;\n  height: 120%;\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, callNumber, menuCtrl, statusBar) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.statusBar.backgroundColorByHexString('#a3cddc');
            // this.statusBar.co
            _this.statusBar.overlaysWebView(false);
            _this.splashScreen.hide();
        });
    };
    AppComponent.prototype.callUs = function () {
        this.callNumber.callNumber("2023350442", true).then(function (res) {
            console.log(res);
        }).catch(function (err) {
            console.log(err);
        });
...
module.exports = __webpack_require__(/*! /Users/villifixinc/Documents/TriangleLegacy/src/main.ts */"./src/main.ts");
